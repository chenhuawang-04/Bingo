...
public final class DictionaryViewModel_HiltModules_KeyModule_ProvideFactory implements Factory<Boolean> {
  @Override
  public Boolean get() {
    return provide();
  }
  ...
  public static boolean provide() {
    return DictionaryViewModel_HiltModules.KeyModule.provide();
  }
