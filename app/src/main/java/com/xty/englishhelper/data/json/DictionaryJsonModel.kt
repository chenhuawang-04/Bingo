...
data class DictionaryJsonModel(
    ...
    val wordClusters: List<WordClusterJsonModel> = emptyList()
)

@JsonClass(generateAdapter = true)
data class WordClusterJsonModel(
    val name: String = "",
...
@JsonClass(generateAdapter = true)
data class WordPoolStrategyJsonModel(
    val strategy: String = "",
    val updatedAt: Long = 0,
    val pools: List<WordPoolJsonModel> = emptyList()
)
