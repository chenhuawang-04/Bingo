...
data class DictionaryUiState(
    ...
    val phraseTagCount: Int = 0,
    val phraseOrganizedWordCount: Int = 0,
    val phraseTotalWordCount: Int = 0,
    val isOrganizingPhrases: Boolean = false,
    val phraseOrganizeProgress: Pair<Int, Int>? = null,
    val phraseOrganizeError: String? = null,
    val currentPhraseOrganizeMessage: String? = null,
    val isPhraseOrganizePaused: Boolean = false,
    val showPhraseOrganizeConfirmDialog: Boolean = false,
