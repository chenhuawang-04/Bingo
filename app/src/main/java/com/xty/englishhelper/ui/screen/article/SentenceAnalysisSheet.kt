...
fun SentenceAnalysisSheet(
    ...
    Column(
        ...
        Text(stringResource(R.string.article_sentence_analysis), style = MaterialTheme.typography.headlineSmall)
        ...
        if (isLoading) {
            ...
            Text(stringResource(R.string.article_analysis_error, error), style = MaterialTheme.typography.bodySmall, color = MaterialTheme.colorScheme.error)
        } else if (analysis != null) {
            if (analysis.meaningZh.isNotBlank()) {
                Column(verticalArrangement = Arrangement.spacedBy(4.dp)) {
                    Text(stringResource(R.string.article_chinese_translation), style = MaterialTheme.typography.titleSmall)
            ...
            if (analysis.grammarPoints.isNotEmpty()) {
                Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
                    Text(stringResource(R.string.article_grammar_points), style = MaterialTheme.typography.titleSmall)
            ...
            if (analysis.keyVocabulary.isNotEmpty()) {
                Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
                    Text(stringResource(R.string.article_key_vocabulary), style = MaterialTheme.typography.titleSmall)
                    FlowRow(
